...
#cas où X et Y sont qualitatifs
...
barplot(tabcont,col=c("red","blue","pink"))
# Au vue de ce graphique, les deux variables
# division et type de défectuosité sont
# liées

# Notons par X:division et Y : type de défectuosité
# On veut tester H0: X et Y sont indépendants
# contre H1 :  X et Y sont dépendants au seuil de 5%
chisq.test(tabcont)
# La p.value du test est égale à 2.28.10^-8 qui 
#est inférieure à 5%. Donc on rejette H0.
#Donc, avec un risque de 5%, la division et le type
# sont liés.
