...
////////////////////////////////////////////////////////////////////////////////
function partitionner(var X : tab; imin : Integer; imax : Integer): Integer;
var i, j, v, tmp : Integer;
begin
	i := imin; j := imax + 1; //imax-1
	v := X[imax];
	while (i <= j) do
	begin
...
//-----------------------------------------------------------------------------//
procedure tri_rapide(var X : tab; imin : Integer; imax : Integer);
var i : Integer;
begin
	if (imin < imax) then
	begin
		i := partitionner(X, imin, imax);
		tri_rapide(X , imin, i); //i-1
